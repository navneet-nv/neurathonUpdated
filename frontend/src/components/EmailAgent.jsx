...
export default function EmailAgent() {
  ...
  const handleRun = async () => {
    ...
    try {
      ...
      const data = await runEmailAgent(payload)
      const formatted =
      ...
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-xs text-zinc-400">
            Draft, personalize, and QA event outreach or follow-up emails.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              rows={10}
              placeholder={`Hi [First Name],\n\nThanks for your interest in [Event Name]...`}
              className="min-h-[180px] resize-y rounded-xl border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm text-zinc-100 outline-none ring-0 transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500/40"
            />
          </div>
